Meteor.startup(function () {
  ...
  if(Incidents.find().fetch().length===0){
    ...
    var buildings = [
      {createdAt: moment().valueOf(), contact: "Luis Fernandez", email: "", phone: "", lat: , lng: , neighboorhood: "", temperature: [24, 21, 45, 18, 20, 23, 26], high: 20, area: 200, , description: "Corrupted read", incident: ""}, 
